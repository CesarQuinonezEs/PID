...
# Botón para enviar la matriz
    submit_button = tk.Button(
        new_window, text="Enviar Matriz", command=submit_matrix)
...
def seleccionar_opcion():
    ...
    if opcion_seleccionada == "Suavizado":
        ...
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado BORDER_REPLICATE")
    elif opcion_seleccionada == "BORDER_REFLECT":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado BORDER_REFLECT")
    elif opcion_seleccionada == "BORDER_WRAP":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado BORDER_WRAP")
    elif opcion_seleccionada == "Filtro promedio":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado Filtro promedio")
    elif opcion_seleccionada == "Filtro gaussiano":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado Filtro gaussiano")
        ...
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado Gradiente en X")
    elif opcion_seleccionada == "Gradiente en Y":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado Gradiente en Y")
    elif opcion_seleccionada == "Laplaciano":
        messagebox.showinfo("Opción seleccionada",
                            "Has seleccionado Laplaciano")
...
boton_activar = tk.Button(root, text="Activar Opción",
